    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <x-nav-link href="/" :active="request()->is(patterns: '/')">Home</x-nav-link>
                <x-nav-link href="/jobs" :active="request()->is(patterns: 'jobs')">Jobs</x-nav-link>
        ...
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contacts</a>
        </div>
        <div class="border-t border-white/10 pt-4 pb-3">
            ...
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">Mahmoud Elkhayat</div>
                <div class="text-sm font-medium text-gray-400">mahmoud.developer2@gmail.com</div>
            </div>
